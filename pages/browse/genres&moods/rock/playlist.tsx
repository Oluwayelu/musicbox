      ...
      <div className="self-start w-full px-5 md:px-32 py-5 text-white space-y-5">
        <div className="w-full flex items-end space-x-10 bg-gray-600">
          ...
          <NavItem
            ...
            active={active}
            setActive={setActive}
            route={BROWSE + GENRES_AND_MOODS + ROCK + "/new-releases"}
          />
          <NavItem
            name="ARTISTS"
            active={active}
            setActive={setActive}
            route={BROWSE + GENRES_AND_MOODS + ROCK + "/artists"}
          />
        </div>
        <div id="">
          <p className="text-xl sm:text-2xl font-semibold">Popular playlists</p>
